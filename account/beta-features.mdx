...
<Note>Earlier versions of this page described Sentry-based diagnostics upload and beta-feedback submission controls on this settings page. Those controls are not present in the current build — use `Relay > Settings > Help` to export logs or copy a diagnostic summary, and email `support@ondeckapps.com` directly for beta feedback.</Note>
